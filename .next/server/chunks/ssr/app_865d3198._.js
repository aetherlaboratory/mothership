...
"[project]/app/lib/loginUser.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function loginUser(username, password) {
    ...
    if (data.success) {
        ...
        // 🔥 Fetch full user info from WordPress
        const userData = await getUserData(data.token);
        if (userData) {
            localStorage.setItem('userData', JSON.stringify(userData));
            return userData // return this for use in UI
            ;
        } else {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$loginUser$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/loginUser.js [app-ssr] (ecmascript)");
'use client';
;
;
;
...
const ScheduleLoginForm = ({ onSuccess })=>{
    ...
    const formik = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$formik$2f$dist$2f$formik$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFormik"])({
        ...
        onSubmit: async (values)=>{
            ...
            setError(null);
            try {
                const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$loginUser$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginUser"])(values.username, values.password);
                const token = localStorage.getItem('token') // loginUser sets it here
                ;
                // 🧠 Sync to main system key
                localStorage.setItem('userToken', token);
                localStorage.setItem('userData', JSON.stringify(user));
                // Callback to parent to update UI + close modal
...
function UserSchedule() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (!token) {
            console.warn('🔴 No user token found — user is NOT logged in');
            setUser(null);
        } else {
            ...
            showLogin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$ScheduleLoginForm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                            onSuccess: (user, token)=>{
                                localStorage.setItem('userToken', token);
                                localStorage.setItem('userData', JSON.stringify(user));
                                setUser(user);
                                setShowLogin(false);
                                window.dispatchEvent(new Event('storage')) // optional sync
                                ;
                            }
                        }, void 0, false, {
                            fileName: "[project]/app/schedule/components/UserSchedule.js",
...
//# sourceMappingURL=app_865d3198._.js.map