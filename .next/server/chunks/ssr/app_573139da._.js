...
(()=>{
    const e = new Error("Cannot find module './getBaseUrl'");
...
async function getWpApiBase() {
    ...
    if (typeof base !== 'string') {
        console.warn('⚠️ getBaseUrl() did not return a string. Using fallback.');
        return "TURBOPACK compile-time value", "https://mothership.wordifysites.com/wp-json";
    }
    if (base.includes('localhost')) {
        return "TURBOPACK compile-time value", "http://localhost:3000/wp-json";
    }
    if (base.includes('192.168.')) {
        return "TURBOPACK compile-time value", "http://192.168.1.185:3000/wp-json";
    }
    return "TURBOPACK compile-time value", "https://mothership.wordifysites.com/wp-json";
}
}}),
...
//# sourceMappingURL=app_573139da._.js.map