...
const EventsPage = ()=>{
    ...
    // Fetch events from your custom WP REST API
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchEvents = async ()=>{
            try {
                console.log("1. Loading events...");
                const res = await fetch(`${("TURBOPACK compile-time value", "https://mothership.wordifysites.com/wp-json")}/custom/v1/events`);
...
//# sourceMappingURL=app_events_d6858ae0._.js.map