// app/appointments/components/EmailModalButton.js
...
export default function EmailModalButton({ userName }) {
        ...
        <DialogContent className="max-w-md">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input type="text" className="w-full border p-2 rounded" placeholder="Subject..." />
            </div>
            <div>
